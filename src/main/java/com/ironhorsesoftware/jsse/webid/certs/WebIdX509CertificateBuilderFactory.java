...
public final class WebIdX509CertificateBuilderFactory {
  ...
  private List<String> serverDnsNames;
  ...
  private WebIdX509CertificateBuilderFactory() {
    ...
    serverDnsNames = new java.util.ArrayList<>();
  }
  ...
  /**
   * Adds a new server DNS name.  These will appear on any certificates generated by the
   * {@link WebIdX509CertificateBuilder}s as <code>dNSName</code>.  Similar to SPI, the
   * name can be used by the server to determine which server-side certificate chain to
